"""
Production FinVoice FastAPI Application - Simplified Main
Clean, focused implementation with real data and production services
"""
...
class PortfolioRequest(BaseModel):
    user_id: str = Field(default="demo_user", description="User identifier")
    force_refresh: bool = Field(default=False, description="Force price refresh")
...
async def health_check():
    ...
    try:
        ...
        overall_status = "healthy" if any(services_status.values()) else "degraded"
...
async def create_portfolio_snapshot(
    ...
    try:
        snapshot_result = await portfolio_service.create_portfolio_snapshot(
            ...
            db=db,
            blockchain_log=settings.ENABLE_BLOCKCHAIN_LOGGING
        )
...
async def get_demo_portfolio():
    ...
    return {
        ...
        "todayChange": 12500.00,
        "todayChangePercent": 1.69,
        "currency": "INR",
        "holdings": [
            {
                "symbol": "RELIANCE.NS",
